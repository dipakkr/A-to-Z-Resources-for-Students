 Risorse dalla A alla Z per studenti :boy:![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)

> ## Sentiti libero di mostrare il tuo amore :heart: mettendo una stella :star:

> ## [Scopri la lista dei nostri contributori:heart::heart:](CONTRIBUTORS.md) - **Aggiungi i tuoi dettagli qui**

### Sei uno studente universitario oppure un professionista alla ricerca di alcune risorse per imparare un nuovo linguaggio? Stai cercando di conoscere nuove persone nella tua comunità o stai cercando delle conferenze internazionali, hackathons o competizioni? Se è così, dovresti assolutamente dare un'occhiata qui.

Quando ero all'università, ho perso tante opportunità come hackathons, conferenze, tirocini e molti eventi internazionali perchè non sapevo della loro esistenza. Io non voglio che i nuovi aspiranti sviluppatori soffrano come me. Quindi, io e un paio di altri sviluppatori da tutto il mondo, abbiamo collezionato una lista di risorse per gli studenti. Se sei all'università o stai entrando nel mondo dello sviluppo, devi assolutamente dare un'occhiata qui. 
...
1.  [Risorse per i linguaggi - Come imparare xyz ](#1-coding-resources-pencil)
...
2.  [ Hackathons ed Eventi ](#2-hackathons-and-events)
     - [Top Hackathons](#21-rainbow-top-global-hackathons)
     - [Competizioni](#22-competitions-bomb)
     - [Portale di ricerca Hackathon](#23--hackathon-search-portals-dart)
     - [Eventi](#24-events-heart_eyes)
     - [Startup Summits e Competizioni](#25-startup-summits-competitions-and-bootcamps-neckbeard)
     - [Sfide per i colloqui](#26-hiring-challenges-heart)

3.  [ Benefici per studenti e Programmi ](#3-student-benefits-and-programs-fire)
     - [Programma Ambasciatore Universitario](#campus-ambassador-programs-v)
     - [Benefici studenti e pacchetti](#student-benefits-and-packs-v)
     - [Associazioni studenti](#student-fellowship-programs-v)
     - [Borse di studio](#scholarships-runner)

4.  [ Open Source ](#4-open-source-programs-octocat)
5.  [Startup e Incubatori](#5-startup-programs-and-incubators-mag_right)
6.  [ Portale tirocini ](#6-internship-portals-smile)
7.  [ Clubs Sviluppatori e Meetups](#7-developer-clubs-and-meetups)
8.  [ Conferences per studenti ](#8-conferences-bookmark_tabs)
9.  [Migliori da seguire](#9-top-people-to-follow)
10. [Migliori siti da seguire](#10-top-websites-to-follow)
11. [Altri links](#11-additional-links-hamster)
12. [Contributori](CONTRIBUTORS.md)
