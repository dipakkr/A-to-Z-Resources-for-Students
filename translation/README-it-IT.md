# Dalla A alla Z Risorse per Studenti:boy:![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)

> ## Sentiti libero di mostrare il tuo amore :heart: dando una stella :star:

> ## [Guarda la lista dei collaboratori :heart::heart:](CONTRIBUTORS.md) - **Aggiungi qui i tuoi dettagli**

### Sei uno studente universitario o un professionista alla ricerca di risorse per imparare un nuovo linguaggio? Vuoi incontrare nuove persone nella tua comunità oppure sei alla ricerca di conferenze globali, hackathons e competizioni a cui partecipare? Allora, guarda assolutamente qua.

Quando ero all'università, ho perso molte opportunità tipo hackathons, conferenze, stage e molti eventi globali poichè non ero a conoscenza della loro esistenza. Non voglio che i futuri sviluppatori soffrano la stessa situazione. Quindi, io e un gruppo di sviluppatori provenienti da tutto il mondo, abbiamo raccolto una lista di risorse per gli studenti. Se sei all'università, ti sei laureato oppure stai iniziando la tua carriera di sviluppatore, devi assolutamente guardare queste risorse!

![Image](res/xx.gif)

*Crediti dell'immagine: Google*

## Tabella dei Contenuti :clipboard:

1.  [ Risorse per la programmazione - Come imparare xyz ](#1-coding-resources-pencil)

     - [Python](#11-python-snake)
     - [Machine Learning - Apprendimento automatico](#12-machine-learning-robot)
     - [Deep Learning - Apprendimento profondo](#13-deep-learning)
     - [Sviluppo per Android](#14-android-development-iphone)
     - [Sviluppo Backend](#15-backend-development-computer)
     - [Sviluppo Web Frontend](#16-frontend-web-development-computer)
     - [Strutture Dati](#17-data-structures-chart_with_upwards_trend)
     - [Tutorial di Alexa](#18-alexa-tutorials)
     - [Linguaggio C](#19-c-language)
     - [Linguaggio C++](#110-c-language)
     - [Git e Github](#111-git-and-github-octocat)
     - [Linguaggio R](#112-r-language)
     - [Haskell](#113-haskell)
     - [DevDocs - documentazione API per la maggior parte dei linguaggi di programmazione (funziona offline)](https://devdocs.io)

2.  [ Hackathons ed Eventi ](#2-hackathons-and-events)
     - [Migliori Hackathons Globali](#21-rainbow-top-global-hackathons)
     - [Competizioni](#22-competitions-bomb)
     - [Portali di ricerca delle Hackathon](#23--hackathon-search-portals-dart)
     - [Eventi](#24-events-heart_eyes)
     - [Startup Summit, Competizioni e Bootcamps](#25-startup-summits-competitions-and-bootcamps-neckbeard)
     - [Hiring Challenges - Prove di assunzione](#26-hiring-challenges-heart)

3.  [ Benefit e Programmi per Studenti ](#3-student-benefits-and-programs-fire)
     - [Programmi Campus Ambassador](#campus-ambassador-programs-v)
     - [Benefit e Pacchetti per Studenti](#student-benefits-and-packs-v)
     - [Programmi per le Compagnie di Studenti](#student-fellowship-programs-v)
     - [Borse di studio](#scholarships-runner)

4.  [ Programmi Open Source ](#4-open-source-programs-octocat)
5.  [Programmi Startup e Incubatori aziendali](#5-startup-programs-and-incubators-mag_right)
6.  [ Portali Stage ](#6-internship-portals-smile)
7.  [Club e Incontri degli sviluppatori](#7-developer-clubs-and-meetups)
8.  [ Conferenze per studenti ](#8-conferences-bookmark_tabs)
9.  [Migliori Persone da seguire](#9-top-people-to-follow)
10. [Migliori Websites da seguire](#10-top-websites-to-follow)
11. [Link Aggiuntivi](#11-additional-links-hamster)
12. [Collaboratori](CONTRIBUTORS.md)

=============================================================================================
# 1. Risorse per la programmazione :pencil:

## 1.1 Python :snake:

> [**Controlla questo collegamento per delle informazioni dettagliate su Python**](Python.md)
...
## 1.2 Machine Learning - Apprendimento automatico :robot:

> [**Controlla questo collegamento per delle informazioni dettagliate su Machine Learning and Deep Learning**](ML.md)
...
-  **Migliori Corsi Online**
    ...
    - [Data Science Machine Learning Bootcamp](https://courses.learncodeonline.in/learn/Machine-Learning-Bootcamp?tab=1) - **A PAGAMENTO**
...
-  **Le migliori Repositories GitHub da seguire**
...
-  **Testa i Modelli ML sui Dataset**
    - [Kaggle](https://www.kaggle.com/)
    - [UCI ML Repository](https://archive.ics.uci.edu/ml/datasets.html)
    - [Data.Gov](https://www.data.gov/)


## 1.3 Deep Learning - Apprendimento Profondo
...
## 1.4 Sviluppo per Android :iPhone:

-  [For Beginners](Android.md)
-  [Udacity - Free courses & Nanodegree](https://udacity.com)
-  [PluralSight - Android Developer Track](http://pluralsight.com/) [GRATIS per 60 giorni]
...
## 1.5 Sviluppo Backend :computer:

- [Introduction to backend](https://in.udacity.com/course/intro-to-backend--ud171)

-  **Django - Python**
    - [Try Django | Youtube](https://www.youtube.com/playlist?list=PLEsfXFp6DpzTD1BD1aWNxS2Ep06vIkaeW) - *Il migliore per principianti*
    - [Django Docs ](https://docs.djangoproject.com/en/2.1/)
    - [Django Girls](https://tutorial.djangogirls.org/en/)
    - [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Django) *Buono per principianti*
    - [SimpleIsBetterThanComplex Blog](https://simpleisbetterthancomplex.com/)

-  **Node.JS**
    - [The Complete Node.js Developer Course | UDEMY](https://www.udemy.com/the-complete-nodejs-developer-course-2/) -- **A PAGAMENTO**

    - [Express web framework (Node.js/JavaScript)](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs)

    - [Learn and Understand NodeJS ](https://www.udemy.com/understand-nodejs/?siteID=jU79Zysihs4-ysDvxh6JST3o9mSuR2USMQ&LSNPUBID=jU79Zysihs4) - **A PAGAMENTO**  *Livello Intermedio*

    - [Video Tutorials-Node.js](https://www.youtube.com/watch?v=w-7RQ46RgxU&list=PL4cUxeGkcC9gcy9lrvMJ75z9maRw4byYp) - *Buono per principianti*

    - [Node.js Documentation](https://nodejs.org/dist/latest-v8.x/docs/api/) - *consigliato a tutti*

    - [Node.js Design Patterns by Mario Casciaro](https://github.com/PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code) - *Libro di livelle Avanzato*
...
## 1.6 Sviluppo Web Frontend :computer:

- **HTML5 e CSS3**
    - [HTML and CSS w3schools.com](https://www.w3schools.com/html/default.asp) *Buono per principianti*
...
- **JavaScript**
    ...
    - [JavaScript: The Good Parts by Douglas Crockford](https://www.amazon.com/JavaScript-Good-Parts-Douglas-Crockford/dp/0596517742) *consigliato*
    - [You Don’t Know JS (book series)](https://github.com/getify/You-Dont-Know-JS) *consigliato a tutti*
...
- **Framework di JavaScript**    
    ###### Angular
     - [Angular 7 - The Complete Guide by Maximilian Schwarzmüller](https://www.udemy.com/the-complete-guide-to-angular-2/) - **(Udemy a pagamento)**
    - [The Complete Angular Course: Beginner to Advanced by  Mosh Hamedani](https://www.udemy.com/the-complete-angular-master-class/) - **(Udemy a pagamento)**
    - [Angular Expo](https://angularexpo.com/) - **Bella collezione di siti web, applicazioni ed esperimenti usando Angular**
    - [Made With Angular](https://www.madewithangular.com/) - **Galleria di bei siti web che usano Angular/AngularJS**
     ...
     - [ReactJS Tutorial codecademy](https://www.codecademy.com/learn/react-101) *Interattivo*
     ...
     - [PAID but Worth it | UDEMY](https://www.udemy.com/react-the-complete-guide-incl-redux/) -- **A PAGAMENTO**
     ...
     - [React For Beginners | Wes Bos](https://reactforbeginners.com/) -- **A PAGAMENTO**
     - [Advanced React | Wes Bos](https://advancedreact.com/) -- **A PAGAMENTO**


- **Redux.js**
     - [Video Tutorials - Beginner](https://www.youtube.com/watch?v=1w-oQ-i1XB8&list=PLoYCgNOIyGADILc3iUJzygCqC8Tt3bRXt)
     - [Redux docs](https://redux.js.org/introduction) *Consigliato a tutti*
...
- **Vue.js**
    - [Vue School](https://vueschool.io/courses) -- **GRATIS + A PAGAMENTO**
...
- **DevTools (strumenti di sviluppo) per Frontend**
     ###### Package managers
...
## 1.7 Strutture Dati :chart_with_upwards_trend:

- **Piattaforme Online**
    - [CodeChef](https://www.codechef.com/) - **CodeChef sito di programmazione competitiva**
    - [Codeforces](https://codeforces.com/) - **Buon sito di preparazione per gare di programmazione**
    - [GeeksforGeeks](https://www.geeksforgeeks.org/must-do-coding-questions-for-companies-like-amazon-microsoft-adobe/) - **Domande di programmazione per aziende di produzione**
    - [Hackerearth](https://www.hackerearth.com/practice/codemonk/) - **Code Monk per iniziare a programmare - fondamenti di programmazione**
    - [Hackerrank](https://www.hackerrank.com/interview/interview-preparation-kit) - **Kit di preparazione interattiva**
    - [InterviewBit](https://www.interviewbit.com/courses/programming) -  **La miglior piattaforma per prepararsi ai colloqui basati sulle Strutture Dati**
    - [LeetCode](https://www.leetcode.com) -  **Piattaforma per prepararsi ai colloqui tecnici con delle vere domande**
    - [Sphere Online Judge](https://www.spoj.com/problems/classical/) - **Buon vantaggio per imparare le Strutture Dati**
    - [UVa Online Judge](https://uva.onlinejudge.org) - **Il sito nel quale inviare [3 problemi di Programmazione Competitiva](http://www.lulu.com/shop/steven-halim/competitive-programming-3/paperback/product-21059906.html) sulle strutture dati**
    - [Codewars](https://www.codewars.com/) - **Interessante sistema con classifica con una bella UI per la preparazione ai colloqui di lavoro e alla programmazione competitiva**
    - [CodinGame](https://www.codingame.com/) - **Programmazione competitiva con le sfide in stile gioco**
    - [CS50 on HarvardX](https://www.edx.org/course/cs50s-introduction-computer-science-harvardx-cs50x) - **Uno dei migliri corsi disponibili online sull'informatica**
    - [Codility](https://app.codility.com/programmers/) - **Sviluppa le tue abilità di programmazione partecipando a lezioni oppure prendendo parte nelle sfide**

- **Libri**
    - [Competitive Programming by Felix Halim and Steven Halim](https://www.comp.nus.edu.sg/~stevenha/myteaching/competitive_programming/cp1.pdf) - **Libro di riferimento per gli entusiasti della programmazione competitiva.**
    - [CLRS](https://mcdtu.files.wordpress.com/2017/03/introduction-to-algorithms-3rd-edition-sep-2010.pdf)  - **Sacra Bibbia per il Design e l'Analisi di algoritmi**
    - [Algorithm Design by Kleinberg Tardos](http://www.cs.sjtu.edu.cn/~jiangli/teaching/CS222/files/materials/Algorithm%20Design.pdf) - **Un altro libro di riferimento per una facile comprensione del design e dell'analisi degli algoritmi**
- [Coding Interview University - Github](https://github.com/jwasham/coding-interview-university) -  **Fortemente consigliato per imparare i fondamenti di DS e Computer Science**
- [Algo & DS in different languages](https://github.com/ZoranPandovski/al-go-rithms) - **Algoritmi e Strutture Dati in
diversi linguaggi di programmazione**
- [Clean code](https://www.amazon.com/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882) - **Clean Code: A Handbook of Agile Software Craftsmanship - Clean code: Guida per diventare bravi artigiani nello sviluppo agile di software**
...
## 1.8 Tutorials di Alexa
 ...
 - [Udemy](https://www.udemy.com/comprehensive-alexa-skill-development-course/?siteID=Fh5UMknfYAU-DbsLrZFg2AAmpu3BgGbHJQ&LSNPUBID=Fh5UMknfYAU) (A PAGAMENTO)
...
# 2. Hackathons ed Events

## 2.1 :rainbow: Migiori Hackathons Globali

|Id | Nome | Luogo | Rimborso spese | Inizio iscrizioni | Termine iscrizioni |
|--|------ |---|---| ------ | ----|
...
##  2.3  Portali di ricerca delle Hackathon :dart:
|s.no| Nome  | Luogo | Categoria |
|---| ------ |---| --- |
...
## 2.4 Eventi :heart_eyes:

> **Controlla questi eventi per la tua area**
...
## 2.5 Startup Summit, Competizioni e Bootcamps :neckbeard:
...
## 2.6 Hiring Challenges - Prove di assunzione :heart:
...
# 3. Benefit e Programmi per Studenti :fire:

## Programmi Campus Ambassador :v:
1. [Microsoft Student Partner](https://studentpartners.microsoft.coem/en-us) - Termine Iscrizione - **Agosto**
...
## Benefit e Pacchetti per Studenti :v:
...
## Programmi per le Compagnie di Studenti :v:
...
4. [Facebook fellowship Program - **Solo per dottorandi**]()
...
12. [Rajiv Gandhi National Fellowship - **Per candidati SC/ST alla ricerca di titoli post-laurea**]()
13. [Gandhi Fellowship - UG/PG Students]()
14. [Ratan Tata Post doctoral Fellowship - **Solo per dottorandi**]()
15. [President Abdul Kalam Azad Postgraduate Fellowship - **Solo per studenti laureati**]()
...
## Borse di studio :runner:
1. [Pytorch Scholarship Challenge - Udacity](https://blog.udacity.com/2018/10/introducing-the-pytorch-scholarship-challenge-from-facebook.html) Termine Iscrizioni - **23 Ottobre** 9:30PM PST
...
=============================================================================================
# 4. Programmi Open Source :octocat:

> **Per informazioni più dettagliate riguardo l'Organizazione GSOC** - [Clicca qui](https://github.com/dipakkr/A-to-Z-Resources-for-Students/blob/master/GSOC.md)


|Id |Nome | Organizzazione| Retribuzione/Incentivi |Timeline | Scadenza |
|-|--|---- |---|---| ------ |
...
# 5. Programmi Startup e Incubatori aziendali :mag_right:
...
5. *Contatta la ricerca del personale su LinkedIn*
6. [Hackkar](https://hackkar.com/)
7. [LetsIntern](https://www.letsintern.com)
8. [Intern Supply](https://intern.supply/)

    ### Consigli per gli stage:

     - Per gli stage estivi, inizia a cercare almeno 3-4 mesi in anticipo.

=============================================================================================

# 7. Club e Incontri degli sviluppatori

> **Prenditi un momento per cercare questi club su Google e Facebook nella tua città.**

> **Controlla **Meetup.com** per altri eventi nella tua zona**
...
=============================================================================================
# 8. Conferenze per studenti :bookmark_tabs:

> ### **Tecnologia, Eventi di Imprenditoria e Conferenze**

|Id | Nome | Luogo | Rimborso spese | Timeline | Scadenza | Tipo |
|--|------ |---|---|:------ |:----|:-----|
...
# 10. Migliori Websites da seguire
...
2.   **Notizie e storie sulle Startup**
...
# 11. Link Aggiuntivi :hamster:

1. [Top 10 Startup Incubator in India](https://inc42.com/resources/top-20-startup-incubators-india/) - *Startup*
2. [The first 20 hours -- how to learn anything](https://www.youtube.com/watch?v=5MgBikgcWnY) - *Apprendimento*
3. [Are you Introvert? Watch this - Power of Introverts ](https://www.youtube.com/watch?v=c0KYU2j0TM4) - *Auto Introspezione*
4. [30 International Scholarships offered by the World’s Top Universities](http://www.scholars4dev.com/13300/international-scholarships-top-universities-world/) - *Borse di studio*
5. [30 Famous Books that You Will Regret Not Reading!](https://bornrealist.com/famous-books/) - *Letture*
6. [Startup Ideas By Y Combinator](https://www.ycombinator.com/rfs/) - *Startup*
7. [Epicodus Coding Bootcamp Full Curriculum](https://www.learnhowtoprogram.com/tracks) - *Apprendimento*
8. [5 most common misconceptions about studying abroad among Indians](https://www.wemakescholars.com/blog/common-misconceptions-about-studying-abroad/) *Studiare all'estero*
