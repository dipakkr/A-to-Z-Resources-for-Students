...
### 새로운 언어를 배우기위한 자원을 찾고있는 대학생 또는 직업 전문가입니까? 지역 사회의 새로운 사람들을 만나거나 글로벌 컨퍼런스, 해커톤 및 대회 참가를 원하십니까? 그렇다면 확실히 확인해야합니다.

대학 시절 해커톤, 컨퍼런스, 인턴십 및 인지도 부족으로 인해 많은 글로벌 이벤트와 같은 많은 기회를 놓쳤습니다. 저는 주니어 개발자들이 저와 같은 고충을 겪는 것을 원치 않습니다. 따라서 저는 다른 개발자들과 함께 학생들을 위한 자원 목록을 수집했습니다. 대학교에 다니고 있으시거나 또는 대학 졸업자이거나 방금 막 개발자로 시작한 사람이라면 반드시 확인해 봐야합니다!
...
> [**파이썬에 대한 자세한 정보는 이 링크에서 찾아보십시오**](../Python.md)

- [Learn Python - CodeAcademy](https://www.codecademy.com/learn/learn-python)
- [Progate Python Classes](https://progate.com/languages/python) - **초심자에게 좋습니다**
...
> [**머신러닝 및 딥러닝에 대한 자세한 정보는 이 링크에서 찾아보십시오**](../ML.md)
...
-  **Node.js**
    ...
    - [Learn and Understand NodeJS ](https://www.udemy.com/understand-nodejs/?siteID=jU79Zysihs4-ysDvxh6JST3o9mSuR2USMQ&LSNPUBID=jU79Zysihs4) - **유료**  *중급*
    ...
    - [Node.js Design Patterns by Mario Casciaro](https://github.com/PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code) - *고급 수준 도서*
...
- **HTML5 와 CSS3**
    - [HTML and CSS w3schools.com](https://www.w3schools.com/html/default.asp) *초심자들에게 좋음*
...
- **자바스크립트 프레임 워크**    
    ...
    - [Angular Expo](https://angularexpo.com/) - **Angular를 이용한 웹사이트, 어플리케이션 및 실험적 요소의 아름다운 쇼케이스**
    - [Made With Angular](https://www.madewithangular.com/) - **Angular / AngularJS를 사용한 영감을주는 웹 사이트 갤러리**
...
## 2.1 :rainbow: 상위 글로벌 해커톤

|Id |이름 | 장소| 경비 지원 |시작 날짜 | 신청 마감 날짜 |
|--|------ |---|---| ------ | ----|
|1| [Smart India Hackathon](https://innovate.mygov.in/sih2018/)| 인도| Yes| 4월 |웹사이트 참고 |
...
|25 | [Mercari Euro Hack](https://challengerocket.com/) | 온라인 + 현장 (폴란드) | Yes | 10월 중순 |- |
...
|30 | [Hack Western](https://hackwestern.com/) | 현장 (캐나다 웨스턴온타리오대학교) | Yes (on a case by case basis) | 11월 말 | 10월 중순 |
|31 | [YHack](https://www.yhack.org/) | 현장 (예일대학교) | Yes | 11월 말 | - |
|32 | [IOT for Smart Life-REVA University](https://reva-university-iot-for-smart-life.hackerearth.com) | 현장 (Reva대학교) | October (Idea Submission) | 11월 말 | - |
...
|2 | [ACM - ICPC](https://www.codechef.com/icpc/2019) | 온라인 & 현장 |
...
4. Paytm Build for India Workshops [ Delhi, Banglore ]
...
## 2.5 스타트 업 서밋, 대회 및 부트 캠프 :neckbeard:
...
|3 | [Startup Grind Global Conference](http://www.startupgrind.com/conference/#/) | 캘리포니아 레드우드시티 |
...
## 장학금 :runner:
1. [Pytorch Scholarship Challenge - Udacity](https://blog.udacity.com/2018/10/introducing-the-pytorch-scholarship-challenge-from-facebook.html) 신청 마감일 - **10월 23일** 9:30PM 태평양 표준
...
> **GSOC 참여에 관한 자세한 정보** - [Click Here](https://medium.com/@rohithasrk/getting-started-with-google-summer-of-code-7dfb8f6d4572)
...
| [Igalia Coding Experience Program](https://www.igalia.com/about-us/coding-experience)| Yes |
  ...
  *인턴은 현재 미국의 대학 또는 기타 연구 기관에 등록 또는 고용되어 있어야하며 현재 미국에 거주해야하며 미국에서 일할 자격이 있어야합니다.<br />
**OSoC는 벨기에 학생들에게만 공개됩니다.
...
| [Bountiful Open Source Summer- BOSS](https://lab.codingblocks.com/boss) | 우승자에게 상품 지급*|
...
| [Hacktoberfest](https://hacktoberfest.digitalocean.com/) | 스웩 넘치는 보상|
...
| [Girlscript Summer of Code](http://gssoc.tech/) | 우승자에게 상품, 스웩 넘치는 보상 지급 및 인턴십 기회 제공|
...
7. [Intern Supply](https://intern.supply/)
    ...
    ### 인턴십을 위한 팁:
     ...
     - 여름 인턴십을 시작하기 전에 최소한 3-4개월 전에 미리 살펴보십시오.

=============================================================================================

# 7. 개발자 클럽 및 밋업

> **잠시 시간을 내어 거주하는 도시에서 Google 및 Facebook에서 이 클럽들을 검색하십시오.**

> **더 많은 이벤트를 위해 **Meetup.com**검색**
...
- Paytm Build for India **[ 델리와 방갈로르에서만 ]**
- Python Student Community - [PyDelhi](https://www.meetup.com/pydelhi/events/254577423/)
- Toastmaster International
- Swift Users Group
- MUG - MongoDB User Group (밋업)

=============================================================================================
# 8. 학생들을 위한 컨퍼런스 :bookmark_tabs:

### **기술, 기업가 정신 이벤트 및 컨퍼런스**

|Id | 이름 | 장소| 여행 경비 제공 |행사 시작일 | 행사 마감일 | 유형 | 
|--|------ |---|---|:------ |:----|:-----| 
...
|5 | [Asia Pacific Week](http://asiapacificweek.anu.edu.au/) | 오스트레일리아 | 부분적으로 | 6월 24일 | 6월 29일 | - |
|6 | [DotJS](https://www.dotjs.io/) | 프랑스 | - | 11월 9일 | 11월 9일 | - |
|7 | [PyCon](https://www.pycon.fr/2018/) | 프랑스 | - | 10월 4일 | 10월 7일 | - |
...
|15|  [Clinton Global Initiative University](http://www.cgiu.org/) | 미국 | - | 3월~10월(매년 변동) | 3일 | - |
|16| [South American Business Forum](https://www.sabf.org.ar/) | 아르헨티나 | 부분적으로 | 8월 3일 | 8월 5일 | - |
|17| [Capital One Summit for Developing Leaders](https://campus.capitalone.com/summits/) | 버지니아 | YES | Jan6 | Jan11 | - |
...
|23| [TechCrunch Disrupt](https://techcrunch.com/event-info/disrupt-sf-2018/) | 미국 | NO | 11월 5일 | 11월 7일 | - |
...
|28| [JAMstack conf](https://jamstackconf.com/) | 미국 | No | 8월 29일-30일 | 10월 29일 | - |
|29| [Blend Web Mix](https://www.blendwebmix.com/) | 프랑스 | - | 10월 24일-25일 | - |
|30| [JS Mobile Conf](https://jsmobileconf.com/) | 미국 | - | 10월 25일-26일  | - | - |
|31| [CascadiaJS](https://2018.cascadiajs.com/) | 미국  | - |11월 15일-16일  | - | - |
|32| [The Rich Web Experience](https://therichwebexperience.com/conference/clearwater/2018/12/home)| 미국  | - | 12월 2일-5일 | - | - |
|33| [JS Kongress](https://js-kongress.com/) | 뮌헨  | - | 3월 11일-12일  | - | - |
|34| [JSConf US](https://jsconf.com/)| 미국 | - |8월 21일-23일 | - | - |
|35| [Fluent](https://conferences.oreilly.com/fluent/fl-ca)| 미국 | -  | 6월 11일-14일 | - | - |
|36| [dotJS](https://www.dotjs.io/) | 프랑스 | - | 11월 9일  | - | - |
|37| [ViewSource](https://events.mozilla.org/viewsource2018) | 런던 | - | 10월 26일  | - | - |
|38| [SmashingConf NY](https://smashingconf.com/) | 미국 | No | 10월 23일 | 10월 24일 | - |
|39| [Hackference India ](http://hackference.in/) | 인도 | No | 11월 | 12월 중순 | - |
|40| [Midwest JS](http://www.midwestjs.com/#/main)| 미국 | - | 8월 8일-10일 | - | - |
|41| [HolyJS](https://holyjs.ru/en/)| 모스크바 | - | 11월 24일-25일 | - | - |
|42| [SIGGRAPH](https://s2019.siggraph.org/) | 글로벌 | - | 7월 29일-8월 1일 | - | - |
|43| [SIGGRAPH Asia](https://sa2018.siggraph.org/en/) | 도쿄 | - | 12월 4일-7일 | - | - |
...
|6 |[Yann LeCun](https://www.facebook.com/yann.lecun) | 페이스북 부사장 겸 최고 AI 과학자 |
|7 |[Martin Fowler](https://twitter.com/martinfowler) | 소프트웨어 개발자 |
|8 |[Uncle Bob Martin](https://twitter.com/unclebobmartin) | 소프트웨어 개발자 |
|9 |[Kyle Simpson](https://twitter.com/getify) | You Don't Know JS 작가 |
|10|[Richard Stallman](https://stallman.org/) | GNU 프로젝트 설립자 |
|11 |[Jen Simmons](https://twitter.com/jensimmons) | CSS 전문가, 파이어폭스 Grid Inspector의 창시자. |
|12 |[Mike Cohn](https://twitter.com/mikewcohn) | Scrum and Agile 옹호자, Mountain Goat Software의 소유자 인 Scrum Alliance의 설립자 중 한 명. |
|13 |[John ResigVerified account](https://twitter.com/jeresig) | jQuery 창시자|
|14 |[Vaughn Vernon](https://vaughnvernon.co/) | Domain Driven Design 전문가 |
|15|[Evan You](https://twitter.com/youyuxi) | Vue.js 창시자|
|16|[Taylor Otwell](https://twitter.com/taylorotwell) | Laravel 창시자|
|17 |[Benjamin Pasero](https://twitter.com/benjaminpasero) | 마이스로소프트 소프트웨어 엔지니어, Visual Studio Code 개발자 |
